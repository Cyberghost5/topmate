<?php
	...
	class Model{
		...
		// public static $dbName="summeraf_blazesub"; //Database Name
		// public static $username="summeraf_blazesub"; // Database Username
		// public static $password="#_@i_jfh4;rT"; //Database Password
        public static $dbName="topmate1"; //Database Name
		public static $username="root"; // Database Username
		public static $password=""; //Database Password
 
        public $dbh;
        
		public $emailUsername="support@blazesub.com"; //Support Email Address
		public $emailPassword="datavendor1@"; //Support Email Password
