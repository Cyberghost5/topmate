<?php
    ...
    class Cable extends ApiAccess{
        ...
        public function purchaseCableTv($body,$cableid,$provider,$cableplan){
            ...
            // Add ringo API like airtime too
             if(strpos($host, 'ringo.ng') !== false){
                ...
                return $this->purchaseCableWithRingo($body,$host,$hostuserurl,$apiKey,$cableid,$provider,$cableplan);
             }
        ...
        public function purchaseCableWithRingo($body,$host,$hostuserurl,$apiKey,$cableid,$provider,$cableplan){
            ...
            // Requesct according to cable id
            if($cableid == 1) {
                $ultimateRequest = '{
                    "serviceCode" : "P-TV",
                    "type" : "GOTV",
