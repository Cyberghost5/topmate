...
<script>
  ...
  function deleteDataPin(id){
    swal({   
      ...
      //Delete Data Plan
    function deleteFlashNoti(id){
    swal({   
              title: "Are you sure?",   
              text: "Are you sure you want to delete this Flash message?",   
              type: "warning",   
              showCancelButton: true,   
              confirmButtonColor: "#DD6B55",   
              confirmButtonText: "Yes",   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?delete-flash-noti",{id:id},function(res){
                   
                  if(res == 0){
                    swal("Success", "Flash message Deleted Succesfully", "success");
                    setTimeout(function(){
                      $url=window.location.href;
                      window.location.href=$url;
                    },1000);   
                  }
                  else{swal("Error!", "Unable To Flash message, Please Try Again Later", "error");   }
                });   
              } else {     
                  swal("Cancelled", "Flash message Not Deleted)", "error");   
              } 
      });
  }
