					  ...
					  <form  method="post" class="form-submit">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <div class="">
                                <input type="text" placeholder="Plan Id" name="planid" class="form-control" required="required" >
                                </div>
                            </div>
					...
					<div class="modal-content border">
                      ...
                      <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label for="success" class="control-label">Plan Id</label>
                                <div class="">
                                <input type="text"  id="planid" placeholder="Plan Id" name="planid" class="form-control" required="required" >
                                </div>
                            </div>
