               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kycnincharges" value="<?php echo $data->kycNinCharges; ?>" class="form-control" >
                        ...
                        <div class="form-group">
                    <label for="success" class="control-label">Enable User Registration</label>
                    <div class="">
                    <select name="registrationEnable" class="form-control" >
                        <option value="">Select Option</option>
                        
                        <?php if($data->registrationEnable == 'on'):
                                    echo '<option value="on" selected>Allow User Registration</option>'; 
                                    echo '<option value="off">Don\'t allow(Disable)</option>'; 
                                else:
                                    echo '<option value="off" selected>Registration disabled</option>'; 
                                    echo '<option value="on">Allow User Registration</option>'; 
                                endif;
                        ?>
