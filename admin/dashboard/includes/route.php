<?php
    ...
    */
    ...
    //Update Api Configurations
    if(isset($_POST["update-bellbank-config"])){
        $msg=$controller->updateApiConfiguration();
    }
    
     //Update Billstack Configurations
    if(isset($_POST["update-billstack-config"])){
        $msg=$controller->updateApiConfiguration();
    }
...
if (isset($_POST["update-data-type-map"])) {
    $msg = $controller->mapDataType();
}

// Fetch Data Type Mappings
if (isset($_GET["get-data-type-mappings"])) {
    $controller->getDataTypeMappings();
}
    ...
    if(isset($_GET["delete-flash-noti"])){
        $msg=$controller->deleteFlashNoti();
        exit();
    }
    ...
    if(isset($_POST["add-flash-noti"])){
        $msg=$controller->addFlashNoti();
    }
 ...
 //Update Strowallet Configurations
    if(isset($_POST["update-strowallet-config"])){
        $msg=$controller->updateApiConfiguration();
    }
    ...
    function getDataIfAny($page){
        ...
        switch($page){
            ...
            case "credit-user-account":
               
                $data=$controller->getPendingManualFund();
                return $data;
                break;
            ...
            case "payvessel-settings":
               ...
               case "strowallet-settings":
                ...
                $data=array();
                $data[0]=$controller->getNotificationStatus();
                $data[1]=$controller->getFlashNoti();
                return $data;
                break;
