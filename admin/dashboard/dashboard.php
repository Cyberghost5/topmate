							...
							<div class="row no-gutters py-2">
								...
								<div class="box-body br-1 border-light no-radius">
									<div class="d-flex align-items-center justify-content-between">
										...
										<div>										
											<h2 class="text-success my-0 text-right">N<?php echo number_format($data[0]["uwCount"] ?? 0); ?> </h2>
								...
								<div class="box-body br-1 border-light no-radius">
									<div class="d-flex align-items-center justify-content-between">
										...
										<div>										
											<h2 class="text-success my-0 text-right">N<?php echo number_format($data[0]["awCount"] ?? 0); ?></h2>
								...
								<div class="box-body br-1 border-light no-radius">
									<div class="d-flex align-items-center justify-content-between">
										...
										<div>										
											<h2 class="text-success my-0 text-right">N<?php echo number_format($data[0]["vwCount"] ?? 0); ?></h2>
								...
								<div class="box-body br-1 border-light no-radius">
									<div class="d-flex align-items-center justify-content-between">
										...
										<div>										
											<h2 class="text-success my-0 text-right">N<?php echo number_format($data[0]["rwCount"] ?? 0); ?></h2>
