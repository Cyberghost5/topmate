...
<div class="col-12">
    ...
    <div class="box-header with-border d-flex align-items-center justify-content-between">
        ...
        <?php foreach($data AS $network): if($network->network == $_GET["network"]): ?>
                ...
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Awoof</label>
                    <div class="">
                        <select name="data" class="form-control" required="required">
                        <?php if($network->dataStatus == "On"): ?>
                            <option value="On" selected>Enable</option>
                            <option value="Off">Disable</option>
                        <?php else: ?>
                            <option value="On">Enable</option>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="">
                        <input type="number" name="giftingId" value="<?php echo $network->giftingId; ?>" class="form-control" placeholder="Gifting ID" required />
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="">
                        <input type="number" name="corporateId" value="<?php echo $network->corporateId; ?>" class="form-control" placeholder="Corporate ID" required />
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <div class="">
                        <input type="number" name="couponId" value="<?php echo $network->couponId; ?>" class="form-control" placeholder="Data Coupon ID" required />
                    </div>
                </div>
                
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Awoof ID</label>
                    <div class="">
                        <input type="number" name="dataId" value="<?php echo $network->dataId; ?>" class="form-control" placeholder="Data Share ID" required />
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Recharge Pin ID</label>
                    <div class="">
                        <input type="number" name="rId" value="<?php echo $network->rId; ?>" class="form-control" placeholder="SME ID" required />
                    </div>
                </div>
                
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Data Pin ID</label>
                    <div class="">
                        <input type="number" name="dId" value="<?php echo $network->dId; ?>" class="form-control" placeholder="SME ID" required />
                    </div>
                </div>
