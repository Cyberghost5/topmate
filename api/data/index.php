<?php
    ...
    if(!isset($body->ref)){$body2["ref"]="DATA_".rand(100,999)."_".time();}
    ...
    if($result["status"]=="fail"){
        ...
        if($datagroup == "Data Coupon" && $networkDetails["datacouponStatus"] <> "On"){$datagroupmessage="Sorry, {$networkDetails["network"]}  is not available at the moment"; }
