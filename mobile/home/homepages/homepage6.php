    ...
    <div style="background-image:url(../../assets/img/bg/cc.png)">
        ...
        <div class="card notch-clear rounded-0 mb-2" data-card-height="270" style="margin-top: 0.6rem !important; background-color:<?php echo $sitecolor; ?>; opacity:0.9;">
            ...
            <div class="mt-0 mb-5">
                ...
                <div class="card card-style mt-0 mb-5" style="height: 50px; position:relative; z-index:100;">
        ...
        <div class="d-flex justify-content-between align-content-center mb-2">
            ...
            <a href="verify-nin" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(0, 204, 0,0.1);">
                <span class="icon icon-s pt-1" style="color:#00cc00;">
                    <i class="fa fa-id-card font-25"></i>
                </span>
                <p class="mb-2 pt-1 font-13 text-dark"><b>Print NIN</b></p>
            </a>

            <a href="verify-bvn" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(204, 0, 102,0.1);">
                <span class="icon icon-s pt-1" style="color:#cc0066;">
                    <i class="fa fa-fingerprint font-25"></i>
                </span>
                <p class="mb-2 pt-1 font-13 text-dark"><b>Print BVN</b></p>
            </a>

            <a href="statistics" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(0, 102, 255,0.1);">
                <span class="icon icon-s pt-1" style="color:#0066ff;">
                    <i class="fa fa-chart-bar font-25"></i>
                </span>
                <p class="mb-2 pt-1 font-13 text-dark"><b>Statistics</b></p>
            </a>
        ...
        <div class="d-flex justify-content-between align-content-center mb-2">
            ...
            <a href="recharge-pin" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(0, 102, 255,0.1);">
                <span class="icon icon-s pt-1" style="color:#0066ff;">
                    <i class="fa fa-barcode font-25"></i>
                </span>
                <p class="mb-2 pt-1 font-13 text-dark"><b>Recharge Card</b></p>
            </a>
            ...
            <a href="verify-pnv" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(204, 0, 102,0.1);">
                <span class="icon icon-s pt-1" style="color:#cc0066;">
                    <i class="fa fa-mobile font-25"></i>
                </span>
                <p class="mb-2 pt-1 font-13 text-dark"><b>PVN</b></p>
            </a>
