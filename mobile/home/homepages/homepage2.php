...
<div class="card notch-clear rounded-0 mb-n5 mt-0" data-card-height="200" style="background-color:<?php echo $sitecolor; ?>;">
            <div class="card-body pt-4 mt-2 mb-n2">
                ...
                <h3 class=" font-17 float-end color-white">(<?php echo $controller->formatUserType($data->sType); ?>)  <br>
                9PSB<br>
              <a onclick="copyToClipboard('<?php echo htmlspecialchars($data5->psb); ?>')">
                  <i class="fa fa-copy"></i>
                  <?php echo htmlspecialchars($data5->palmpay); ?> 
