               ...
               <div class="row text-center mb-0">
                ...
                <a href="buy-airtime" class="col-3 mt-2">
                    ...
                    <a href="verify-pnv" class="col-3 mt-2">
                        ...
                        <p class="mb-0 pt-1 font-13">PVN</p>
                    </a>
                    
                    <a href="verify-nin" class="col-3 mt-2">
                        <span class="icon icon-l shadow-l " style="color:<?php echo $sitecolor; ?>;  border-radius:50%; ">
                            <i class="fa fa-id-card  font-18"></i>
                        </span>
                        <p class="mb-0 pt-1 font-13">NIN Printing</p>
                    </a>
                    
                    <a href="verify-bvn" class="col-3 mt-2">
                        <span class="icon icon-l shadow-l " style="color:<?php echo $sitecolor; ?>;  border-radius:50%; ">
                            <i class="fa fa-fingerprint  font-18"></i>
                        </span>
                        <p class="mb-0 pt-1 font-13">BVN Slip</p>
                    </a>
                    
                    <a href="statistics" class="col-3 mt-2">
                        <span class="icon icon-l shadow-l " style="color:<?php echo $sitecolor; ?>;  border-radius:50%; ">
                            <i class="fa fa-chart-bar  font-18"></i>
                        </span>
