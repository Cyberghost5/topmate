    ...
    $("document").ready(function(){
       ...
       $("#electricityForm").submit(function(e){
        ...
        $("#networkid").on("change",function(){
            ...
            let corporate2 = $('#networkid').find(":selected").attr('corporate2');
            let coupon = $('#networkid').find(":selected").attr('coupon');
            let data = $('#networkid').find(":selected").attr('data');
            ...
            let momo = $('#networkid').find(":selected").attr('momo');
             let datacoupon = $('#networkid').find(":selected").attr('datacoupon');
            ...
            let thegroup='<option value="">Select Type</option>';
                ...
                //Check If Network Is Disabled
                if(corporate2=="On"){
                   thegroup+='<option value="Corporate2">Corporate2</option>';
                }
                ...
                //Check If Network Is Disabled
                if(data=="On"){
                   thegroup+='<option value="Awoof">Awoof</option>';
                }
                ...
                if(momo=="On"){
                   ...
                   //Check If Network Is Disabled
                if(datacoupon=="On"){
                   thegroup+='<option value="Data Coupon">Data Coupon</option>';
                }
                ...
                if(!plans == ""){
                    ...
                    for(i=0; i < plans.length; i++){
                        ...
                        if(plans[i].datanetwork == network && plans[i].type == datagroup){
                            options+= "<option value='"+plans[i].pId+"' dataprice='"+price+"' dataname='"+plans[i].name+" "+plans[i].type+" (₦"+price+")("+plans[i].day+" Days) '>"+plans[i].name+" "+plans[i].type+" (₦"+price+")("+plans[i].day+" Days)</option>";
                        }
       ...
       //If  notwork selected, empty data type, plan, amount
        $("#datanetworkid").on("change",function(){
            $("#datapingroup").val(null);
            $("#dataplan").val(null);
            $("#amounttopay").val(null);

            let sme = $('#datanetworkid').find(":selected").attr('sme');
            let gifting = $('#datanetworkid').find(":selected").attr('gifting');
            let corporate = $('#datanetworkid').find(":selected").attr('corporate');
            let sme2 = $('#datanetworkid').find(":selected").attr('sme2');
            let corporate2 = $('#datanetworkid').find(":selected").attr('corporate2');
            let coupon = $('#datanetworkid').find(":selected").attr('coupon');
            let data = $('#datanetworkid').find(":selected").attr('data');
            let vtu = $('#datanetworkid').find(":selected").attr('vtu');
            let sharesell = $('#datanetworkid').find(":selected").attr('sharesell');
            let momo = $('#datanetworkid').find(":selected").attr('momo');
